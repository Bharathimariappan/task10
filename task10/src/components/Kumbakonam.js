...
import Kumbakonam1 from '../images/kumbakonam1 (1).jpeg'
import Kumbakonam2 from '../images/kumbakonam1 (2).jpeg'
import Kumbakonam3 from '../images/Kumbakonam(3).jpeg'
import Kumbakonam4 from  '../images/kumbakonam1 (4).jpeg'
...
const Kumbakonam = () => {
  return (
    <section id='kumbakonam'className='container mt-5'>
    <div >
      <h2 className='primary-heading touristPlaceName'>06. Kumbakonam</h2>
        ...
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
              Located in the town of Darasuram near Kumbakonam in Tamil Nadu, Airavatesvara...<span className='z'style={{ color:"white" }}> most importent </span>
              </Card.Text>
              <Button variant="primary">Read More</Button>
            </Card.Body>
          </Card>
        ...
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>
              Located in the town of Darasuram near Kumbakonam in Tamil Nadu,Airavatesvara Temple is a revered...<span className='z'style={{ color:"white" }}>  the most importent </span>
              </Card.Text>
              <Button variant="primary">Read More</Button>
            </Card.Body>
          </Card>
